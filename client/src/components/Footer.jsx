  ...
  return (
    <div className="row d-flex flex-row w-100 align-items-center gap-5 justify-content-center">
      ...
      <div className="col-lg-12 col-xl-3 d-flex flex-column align-items-center">
        ...
        <Text size="$sm">
          <Link block color="primary" href="/shop">
            Shop
          </Link>
        </Text>
        <Text size="$sm">
          <Link block color="primary" href="/testimonials">
            Testimonials
          </Link>
        </Text>
        <Text size="$sm">
          <Link block color="primary" href="/media">
            Media
          </Link>
        </Text>
        <Text size="$sm">
          <Link block color="primary" href="/resources">
            Resources
          </Link>
        </Text>
        <Text size="$sm">
